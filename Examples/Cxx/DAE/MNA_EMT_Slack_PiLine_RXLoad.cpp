...
int main(int argc, char* argv[])
{
	...
	Real finalTime = 0.1;
	String simName = "MNA_EMT_Slack_PiLine_RXLoad";
	...
	std::vector<Complex> initialVoltage_n2{ Complex(110000, 0), Complex(110000, 0), Complex(110000, 0) };
	...
	Simulation sim(simName, sys, timeStep, finalTime, Domain::EMT, Solver::Type::MNA);
