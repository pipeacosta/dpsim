...
void MnaSolverGpuSparse<VarType>::iluPreconditioner() {
    ...
    cuda::copybackAndPrint<double>(std::cout, "LU: ", d_csrVal, 8);
    cuda::copybackAndPrint<int>(std::cout, "LU: ", d_csrColInd, 8);
    cuda::copybackAndPrint<int>(std::cout, "LU: ", d_csrRowPtr, 4);
}
