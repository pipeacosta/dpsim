...
namespace CPS {
namespace Signal {
class DecouplingLine_EMT_Ph3 : public SimSignalComp,
                          public SharedFactory<DecouplingLine_EMT_Ph3> {
protected:
  Real mDelay;
...
public:
  typedef std::shared_ptr<DecouplingLine_EMT_Ph3> Ptr;
  ...
  DecouplingLine_EMT_Ph3(String name, Logger::Level logLevel = Logger::Level::info);
  ...
  public:
    PreStep(DecouplingLine_EMT_Ph3 &line)
  ...
  private:
    DecouplingLine_EMT_Ph3 &mLine;
  };

  class PostStep : public Task {
  public:
    PostStep(DecouplingLine_EMT_Ph3 &line)
