...
void addSignalComponents(py::module_ mSignal) {
  ...
  py::class_<CPS::Signal::DecouplingLine_EMT_Ph3,
             std::shared_ptr<CPS::Signal::DecouplingLine_EMT_Ph3>,
             CPS::SimSignalComp>(mSignal, "DecouplingLine_EMT_Ph3",
                                 py::multiple_inheritance())
      .def(py::init<std::string>())
      .def(py::init<std::string, CPS::Logger::Level>())
      .def("set_parameters", &CPS::Signal::DecouplingLine_EMT_Ph3::setParameters,
           "node_1"_a, "node_2"_a, "resistance"_a, "inductance"_a,
           "capacitance"_a)
      .def("get_line_components",
           &CPS::Signal::DecouplingLine_EMT_Ph3::getLineComponents);
